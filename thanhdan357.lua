...
local SkibidiButton = Instance.new("TextButton") -- Đổi tên SkibidiButton
local Title = Instance.new("TextLabel") -- Tiêu đề sẽ được tạo ở ngoài ScrollingFrame
...
ScrollingFrame.Position = UDim2.new(0.5, -150, 0.35, 0)  -- Đặt xuống dưới tiêu đề
...
HubButton.Position = UDim2.new(0.1, 0, 0.35, 0)
...
FruitButton.Position = UDim2.new(0.1, 0, 0.6, 0)
...
FarmButton.MouseButton1Click:Connect(function()
    ScreenGui.Visible = false -- Ẩn giao diện thay vì xóa

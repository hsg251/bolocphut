...
local Tabs = {
    About = Window:AddTab({ Title = "tab about" }),
    Main = Window:AddTab({ Title = "tab farm" }),
    Setting = Window:AddTab({ Title = "tab setting" }),
    Stats = Window:AddTab({ Title = "tab stat" }),
    Player = Window:AddTab({ Title = "tap local player" }),
    Teleport = Window:AddTab({ Title = "tap tele" }),
    Fruit = Window:AddTab({ Title = "tab fruit" }),
    Raid = Window:AddTab({ Title = "tab raid" }),
    Race = Window:AddTab({ Title = "tab v4" }),
    Shop = Window:AddTab({ Title = "tap buy item" }),
    Misc = Window:AddTab({ Title = "tab miscellaneous" }),
    Hop = Window:AddTab({ Title = "tab hop" }),
}
...
--------------------------------------------------------------------------------------------------------------------------------------------
-- Hehehhahahahsuhduhsudhw
--------------------------------------------------------------------------------------------------------------------------------------------
--Create Tabs

Tabs.About:AddButton({
    Title = "facebook",
    Description = "Thanh Sơn Lê",
    Callback = function()
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack','Ultra Fast attack'}
	...
	elseif _G.FastAttackFaiFao_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.05
        elseif _G.FastAttackFaiFao_Mode == "Ultra Fast Attack" then
                _G.Fast_Delay = 0.0000000001
	end
end)

shared.LoaderTitle = "thanhdan Hub => SonBeo Hub";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://72084290375057",
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "fb.com/thanh.son.le.581360/",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=72084290375057";
v24.Parent = v23;
...
_G.FastAttackStrix_Mode = "Ultra Fast Attack"
_G.Fast_Delay = 0.00000000000001

spawn(function()
    while task.wait() do
        if _G.FastAttackStrix_Mode then
            pcall(function()
                if _G.FastAttackStrix_Mode == "Ultra Fast Attack" then
                    _G.Fast_Delay = 0.00000000000001
                end
            end)
        end
